    ...
    const mocks: ProductResponse[] = [
      {
        ...
        category: CAT_ELEC, active: true, featured: false, createdAt: '', updatedAt: '',
      },
      {
      ...
      },
      {
        ...
        category: CAT_MODE, active: true, featured: false, createdAt: '', updatedAt: '',
      },
      {
        ...
        category: CAT_MAIS, active: true, featured: false, createdAt: '', updatedAt: '',
      },
      {
        ...
        category: CAT_BEAU, active: true, featured: false, createdAt: '', updatedAt: '',
      },
      {
        ...
        category: CAT_SPOR, active: true, featured: false, createdAt: '', updatedAt: '',
      },
    ];
